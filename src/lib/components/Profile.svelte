	...
	<div class='container m-auto py-5'>
		...
		<div class="flex flex-1 justify-between items-center">
			<div>
				<h1 class='text-3xl font-bold'>
					{user.name}
					<a href='https://hashnode.com/@{user.blogHandle}' class='text-blue-500 hover:text-blue-600'>(@{user.blogHandle})</a>
		...
		<div class='flex'>
			...
			{#if user.socialMedia.google}
				<a class="px-4 py-2 filter-none hover:filter brightness-200" href='{user.socialMedia.google}' target='social'>
			...
			{#if user.socialMedia.linkedin}
				<a class="px-4 py-2" href='{user.socialMedia.linkedin}' target='social'>
					<svg class="text-blue-600 hover:text-blue-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
				</a>
			{/if}

			{#if user.socialMedia.stackoverflow}
				<a class="px-4 py-2 filter-none hover:filter brightness-125" href='{user.socialMedia.stackoverflow}' target='social'>
					<svg width="24" height="24" viewBox="0 0 169.61 200" xmlns="http://www.w3.org/2000/svg"><path d="M140.44 178.38v-48.65h21.61V200H0v-70.27h21.61v48.65z" fill="#bcbbbb"/><path d="M124.24 140.54l4.32-16.22-86.97-17.83-3.78 17.83zM49.7 82.16L130.72 120l7.56-16.22-81.02-37.83zm22.68-40l68.06 57.3 11.35-13.51-68.6-57.3-11.35 13.51zM116.14 0l-14.59 10.81 53.48 71.89 14.58-10.81zM37.81 162.16h86.43v-16.21H37.81z" fill="#f48024"/></svg>
				</a>
			{/if}
		</div>
	</div>
